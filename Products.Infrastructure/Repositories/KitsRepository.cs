...
{
    public class KitsRepository : IKitsRepository, IKitQueries
    {
        private readonly IProductContext _context;
        private readonly IMapper _mapper;

        public KitsRepository(IProductContext context, IMapper mapper)
        {
        ...
        public async Task<List<KitViewModel>> GetAllKitsView()
        {
            var databaseModels = await _context.Kits.Find(kit => true).ToListAsync();
            var viewModel = _mapper.Map<List<KitViewModel>>(databaseModels);
